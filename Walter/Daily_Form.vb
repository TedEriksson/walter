...
Public Class Daily_Form
    ...
    Private Sub DF_Job_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles DF_Job.GotFocus
        SQLReading("SELECT Job_Name FROM Jobs")
    End Sub
    ...
    Private Sub NJ_Done_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NJ_Done.Click
        ...
        SQLWriting("INSERT INTO Workers_Hours(WorkerID, JobID, Date_worked, Hours_worked) VALUES('" + SQLReading("SELECT WorkerID FROM Worker WHERE Worker_Name = '" + DF_Worker.Text + "'").text + "'," + SQLReading("SELECT JobID FROM Jobs WHERE Job_Name = '" + DF_Job.Text + "'").text + ",'" + DF_Date.Text + "','" + DF_Hours_worked.Text + "')")
        MainMenu.Visible = True
        Me.Visible = False
    End Sub
End Class